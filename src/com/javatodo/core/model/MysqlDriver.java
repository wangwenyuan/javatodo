...
public class MysqlDriver extends Driver {
	...
	private List<Object> whereValueList = new ArrayList<Object>();
	private List<Object> dataValueList = new ArrayList<Object>();
	private List<String> batchDataKeyList = new ArrayList<String>();
	private List<List<Object>> batchDataValueList = new ArrayList<List<Object>>();
	private List<Object> updateValueList = new ArrayList<Object>();
	...
	public MysqlDriver where(Map<String, W> where) {
		for (String key : where.keySet()) {
			...
			if (Relation.NOTIN == relation) {
				List<Object> notValues = new ArrayList<Object>();
	...
	// where方法
	public MysqlDriver where(String whereSql) {
		if (whereSql.equals("")) {
			return this;
		} else {
			if (this.whereSql.equals("")) {
	...
	// where方法
	public MysqlDriver where(String whereSql, Object... params) {
		if (whereSql.equals("")) {
			return this;
		} else {
			if (this.whereSql.equals("")) {
	...
	// order方法
	public MysqlDriver order(String orderSql) {
		this.orderSql = " order by " + orderSql;
		return this;
	}

	// limit方法
	public MysqlDriver limit(String limitSql) {
	...
	// alias方法
	public MysqlDriver alias(String asSql) {
		this.asSql = " as " + asSql + " ";
		return this;
	}

	// join
	public MysqlDriver join(String tableName, String onSql) {
	...
	// join
	public MysqlDriver join(String tableName, String onSql, String type) {
		tableName = this.tablePrefix + tableName;
		String sql;
	...
	// filed方法
	public MysqlDriver field(String fieldSql) {
	...
	public void clear() {
		this.sql = "";
		this.whereSql = "";
		this.whereValueList = new ArrayList<Object>();
		this.dataValueList = new ArrayList<Object>();
		this.updateValueList = new ArrayList<Object>();
		this.orderSql = "";
		this.fieldSql = " * ";
		this.limitSql = "";
		this.addSql = "";
		...
		this.batchDataKeyList = new ArrayList<String>();
		this.batchDataValueList = new ArrayList<List<Object>>();
	}
}
