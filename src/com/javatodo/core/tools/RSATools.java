...
public class RSATools {
	 ...
	 * @return
	 */
	public static Map<String, String> createGenerateKeyPair() {
		try {
	...
	public static Map<String, String> createGenerateKeyPair(String filePath) {
		try {
			...
			String privateKeyString = getKeyString(privateKey);
			// 将密钥对写入到文件
			FileWriter pubfw = new FileWriter(filePath + "/key.pub");
			FileWriter prifw = new FileWriter(filePath + "/key.pri");
	...
	public static String publicKeyFileEncrypt(String publicKeyFilePath, String plainText) {
		try {
			FileReader fr = new FileReader(publicKeyFilePath);
	...
	public static String privateKeyFileDecrypt(String privateKeyFilePath, String enStr) {
		try {
			FileReader fr = new FileReader(privateKeyFilePath);
			BufferedReader br = new BufferedReader(fr);
